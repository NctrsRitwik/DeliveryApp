...
extension UIViewController {
    ...
    public func addLeftBarButtonToHome(_ buttonImage: UIImage) {
        let leftButton: UIBarButtonItem = UIBarButtonItem(title: "Threads", style: .plain, target: self, action: #selector(toggleLeft))
        navigationItem.leftBarButtonItem = leftButton
    }
    public func addRightBarButtonToHome(_ buttonImage: UIImage) {
        let rightButton: UIBarButtonItem = UIBarButtonItem(title: "Threads", style: .plain, target: self, action: #selector(toggleRight))
        navigationItem.rightBarButtonItem = rightButton
    }
